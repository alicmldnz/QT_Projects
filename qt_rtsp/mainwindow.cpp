    ...
    ui(new Ui::MainWindow)
{
    ...
    const QUrl url1 =  QUrl("rtsp://192.168.10.43:8887/opt/ali/video.mp4");

    const QUrl url2 =  QUrl("rtsp://192.168.10.43:8554/dev/video1");

    const QUrl url3 = QUrl("rtsp://192.168.10.43:5037/dev/video1");
    const QUrl url4 = QUrl("rtsp://192.168.10.43:8887/dev/video1");
